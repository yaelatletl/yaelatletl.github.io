...
title: Dynamic day-night cycle sky
client: Self
publishDate: 2022-06-12 00:00:00
img: /assets/projects/dynamic-sky/Raleigh.png
description: |
  A "plug and play" addon for the Godot Engine that adds a sky with clouds and a sun that updates as if the day passed.  
tags:
  - godot
  - shader
  - addon
...
![Cheap shader](../../assets/projects/dynamic-sky/Simple_stylish.png)
...
![Raleigh shader](../../assets/projects/dynamic-sky/Raleigh.png)